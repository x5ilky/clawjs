...
export class wav {
    ...
    parseData() {
        ...
        if (chunkType === "data") {
            ...
            throw 'NOT_CANONICAL_FORMAT: unsupported "' + chunkType +
                '"" chunk - was expecting data';
        }
    }
    /**
  ...
  */
     ...
     */
    tolittleEndianDecBytes(a, decimalVal) {
        for (var i = 0; i < a.length; i++) {
            a[i] = decimalVal & 0xFF;
            decimalVal >>= 8;
        }
